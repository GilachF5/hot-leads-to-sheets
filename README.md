...
Функция выгружает купленные и горячие лиды в Google Sheets, чтобы команда могла быстро работать с актуальными заявками.

## Назначение

Выгрузка купленных лидов в GoogleSheets

## Параметры функции

- ID функции: `d4erb0ivc03hrhrqsakl`
- Каталог Yandex Cloud: `sl`
- Статус: `ACTIVE`
- Runtime: `nodejs22`
- Entry point: `index.handler`
- Версий в экспорте: `4`
- HTTP URL: `https://functions.yandexcloud.net/d4erb0ivc03hrhrqsakl`
...
```powershell
cd .\yc-export-author-gilach\sanitized\functions\hot-leads-to-sheets
...
```powershell
yc serverless function version create --function-id d4erb0ivc03hrhrqsakl --runtime nodejs22 --entrypoint index.handler --source-path . --execution-timeout 60s
```
